...
fn apply_normal_map(world_normal: vec3f, world_tangent: vec4f, sample_value: vec3f, normal_scale: f32) -> vec3f {
    return safe_normalize3(build_tbn(world_normal, world_tangent) * unpack_tangent_normal(sample_value, normal_scale));
}
