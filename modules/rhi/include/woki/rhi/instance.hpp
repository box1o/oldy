...
public:
    ...
    [[nodiscard]] virtual Result<ref<Surface>> CreateSurface(const SurfaceDescriptor& desc) = 0;
    [[nodiscard]] virtual Result<ref<Surface>> CreateSurface(Window& window, SurfaceDesc desc = {}) = 0;
    ...
    [[nodiscard]] virtual Future RequestAdapter(RequestAdapterDesc desc, CallbackMode callback_mode, RequestAdapterCallback callback) = 0;
