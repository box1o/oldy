...
function(add_wokiext target)
    ...
    string(JOIN "\n" _allowed_import_contents ${WOKI_WASM_HOST_IMPORTS})
    ...
    file(GLOB_RECURSE _sdk_headers CONFIGURE_DEPENDS "${WOKI_SDK_DIR}/woki/ext/*.h" "${WOKI_SDK_DIR}/woki/ext/*.hpp" "${WOKI_SDK_DIR}/woki/ext/*.def")
    set(_config_flags
        $<$<CONFIG:Debug>:-O0>
        $<$<CONFIG:Debug>:-g>
        $<$<CONFIG:Release>:-O2>
